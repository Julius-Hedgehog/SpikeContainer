    ...
    public partial class PolartecErrorLog : IDisposable
    {
        ...
        public PolartecErrorLog(string applicationId, DateTime dtLastRun)
        {
            ...
            if (applicationId != string.Empty || applicationId != null)
            {
                ...
                stringLogFileName = string.Format(PolartecErrorLog.stringLogFileNameFormat, applicationId, DateTime.UtcNow.Ticks.ToString());
                ...
                //Trace.Listeners.Add(new TextWriterTraceListener(stringLogFileName));// create a trace listener as a run log
